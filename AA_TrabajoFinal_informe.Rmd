...
*Comentarios*: El error de lo pedicho con respecto a Test es de 0,29 lo cual consideramos bastante aceptable.
...
*Comentarios*: El porcentaje de los casos bien clasificados es del 70% lo cual está medianamente bien. El error es del 30% lo cual no está mal. Clasifica medianamente bien a los positivos aunque clasifica bastante mejor a los negativos.

La precisión es casi del 50 %
...
*Comentarios*: El porcentaje de los casos bien clasificados es del 84% lo cual está correcto. El error es del 16% lo cual bien. Clasifica bien a los positivos y bastante mejor a los negativos.

La precisión es casi del 74 %
