...
```{r}
pima<-pima %>%
mutate(pregnant = ifelse(pregnant == 0, 3.0, pregnant), 
       glucose = ifelse(glucose == 0, 117.0, glucose),
       pressure= ifelse(pressure == 0, 72.00, pressure),
       triceps= ifelse(triceps == 0, 29.00, triceps),
       insulin = ifelse(insulin == 0, 125.00, insulin),
       mass= ifelse(mass == 0,32.30, mass),
       pedigree= ifelse(pedigree == 0, 0.37, pedigree),
       age= ifelse(age == 0, 29.00, age),
       )
pima
```
